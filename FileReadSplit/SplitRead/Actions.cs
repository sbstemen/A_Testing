...
namespace SplitRead
{
  ...
  class Actions
  {
    ...
    public IWebDriver CreateUser(IWebDriver webDriver, Help hpCode, UsrData studentNew, ref string[] createdAccount)
    {
      ...
      usrSrchBox.SendKeys(studentNew.LastNameSet);

      hpCode.RandomPause(2);

      createdAccount[0] = studentNew.LogInAlias;
      createdAccount[1] = studentNew.PassWordSet;
      createdAccount[2] = studentNew.EmailSet;
